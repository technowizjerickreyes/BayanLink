...
import { municipalDashboard, readCurrentMunicipality } from "../controllers/municipalController.js";
import {
  addManagedNewsFeed,
...
router.use(requireAuth, requireRole("municipal_admin"));

router.get("/dashboard", municipalDashboard);
router.get("/municipality", readCurrentMunicipality);
